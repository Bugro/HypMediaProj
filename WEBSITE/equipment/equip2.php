...
<body>
  ...
  <div class="content">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <a href="/equipment/" class="btn btn-primary btn-room" role="button">Previous Machine</a>
        </div>
        <div class="col-md-6">
          <a href="/equipment/equip3.php" class="btn btn-primary btn-room" role="button">Next Machine</a>
        </div>
